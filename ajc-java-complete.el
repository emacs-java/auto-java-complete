...
(defcustom ajc-tag-file "~/.java_base.tag"
  "Pathname of the tag file.
The tag file is used for java completion and is generated by a
Tags.java. So before you use this tool, try to compile Tags.java
and use the class to create a tag file. It will tag all jars in
classpath to tag file. To tag specific classes under classpath,
use the follwoing command: java Tags com.whatever.* This will tag
classes under com.whatever packages."
  :type 'string
